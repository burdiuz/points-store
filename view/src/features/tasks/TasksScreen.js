    ...
    <Layout style={{ flex: 1, margin: 20 }}>
        ...
        <Layout
          ...
          <ButtonGroup
            ...
            <Button onPress={() => formik.setFieldValue('amount', 10)}>
              10
            </Button>
            <Button onPress={() => formik.setFieldValue('amount', 15)}>
              15
            </Button>
            <Button onPress={() => formik.setFieldValue('amount', 20)}>
              20
            </Button>
            <Button onPress={() => formik.setFieldValue('amount', 30)}>
              30
            </Button>
            <Button onPress={() => formik.setFieldValue('amount', 50)}>
              50
            </Button>
